  ...
  void _navigateToAddEditScreen({
    ...
    if (categories.isEmpty) {
      AppErrorHandler.show(
        context,
        'Please create a category first before adding menu items.',
      );
      return;
    }
                        ...
                        : RefreshIndicator(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final isEdited = state.editedMenus.containsKey(
                                  item.id,
                                );
                                  ...
                                  child: Stack(
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: Text(
                                          '${category.name} • ${item.estimatedPreparationTime} mins',
                                        ),
                                        trailing: AnimatedAvailabilityToggle(
                                          isAvailable:
                                              state.editedMenus.containsKey(
                                                item.id,
                                              )

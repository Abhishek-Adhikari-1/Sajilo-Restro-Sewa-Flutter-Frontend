...
class _StaffListScreenState extends State<StaffListScreen> {
  ...
  void _showNewPasswordDialog(String name, String password) {
    showDialog(
      context: context,
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                'Staff member $name has been created successfully. Below is the temporary password generated by the server. Please copy it now as it will not be shown again.',
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        AppErrorHandler.show(context, 'Password copied to clipboard');
                      },
                    ),
                  ],
                ),
          ...
          actions: [
            FilledButton(
              onPressed: () {
                context.read<StaffCubit>().clearNewStaffPassword();
      ...
      body: BlocConsumer<StaffCubit, StaffState>(
        listener: (context, state) {
          if (state is StaffLoaded) {
            ...
            if (state.newStaffPassword != null && state.recentlyCreatedStaff != null) {
              final name = "${state.recentlyCreatedStaff!.firstName} ${state.recentlyCreatedStaff!.lastName}";
              _showNewPasswordDialog(name, state.newStaffPassword!);
            }
          }
        },
